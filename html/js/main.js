  ...
  if (selectHeader) {
    ...
    const headerFixed = () => {
      if ((headerOffset - window.scrollY) <= 0) {
        selectHeader.classList.add('header-scroll')
        nextElement.classList.add('scrolled-offset')
      } else {
        selectHeader.classList.remove('header-scroll')
...
new Swiper('.slides-3', {
  ...
  // Partner carousel (uses the Owl Carousel library)
  ...
  $(".testimoanils-slider").owlCarousel({
    autoplay: true,
	  margin: 30,
    dots: true,
    loop: true,
  ...
  // testimonial in about carousel (uses the Owl Carousel library)
